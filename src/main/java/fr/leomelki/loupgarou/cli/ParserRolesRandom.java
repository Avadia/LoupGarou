...
class ParserRolesRandom extends ParserRolesAbstract {
    ...
    protected void displayAvailableRoles(CommandSender sender) {
        ...
        final Map<String, Object> evilWeigths = Objects.requireNonNull(config.getConfigurationSection(MainLg.DISTRIBUTION_RANDOM_KEY + "evilWeigths")).getValues(false);
        final Map<String, Object> neutralWeights = Objects.requireNonNull(config.getConfigurationSection(MainLg.DISTRIBUTION_RANDOM_KEY + "neutralWeights")).getValues(false);
        final Map<String, Object> villagerWeights = Objects.requireNonNull(config.getConfigurationSection(MainLg.DISTRIBUTION_RANDOM_KEY + "villagerWeights")).getValues(false);
