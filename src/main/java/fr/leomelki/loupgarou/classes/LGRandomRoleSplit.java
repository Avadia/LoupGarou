...
public class LGRandomRoleSplit {
    @Getter
    private final double amountOfEvil;
    @Getter
    private final double amountOfNeutral;
    @Getter
    private final double amountOfVillagers;
    ...
    public static LGRandomRoleSplit getCategorySplits(final int maxPlayers, final FileConfiguration config) {
        final Map<String, Object> categoryWeigths = Objects.requireNonNull(config.getConfigurationSection(MainLg.DISTRIBUTION_RANDOM_KEY + "categoryWeights")).getValues(false);
